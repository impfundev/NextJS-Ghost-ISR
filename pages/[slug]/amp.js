  ...
  return (
    ...
    <main className="main-wrapper">
      ...
      <article className="prose lg:prose-xl">
        ...
        <hr />
        {parse(
          content.replace(/<iframe[^>]*loading=(?:[^=>]*="[^"]*"|[^=>\s]*)/gi, (match) => {
            return match.replace(/loading/gi, '')
	  })
          .replace(/<iframe([^>]*)>/gi, (match, sub) => {
...
@font-face {
  ...
  src: url('font/iJWKBXyIfDnIV7nMrXyw023e1Ik.woff2') format('woff2');
...
@font-face {
  ...
  font-weight: 400;
  font-display: optional;
  src: url('font/iJWKBXyIfDnIV7nFrXyw023e1Ik.woff2') format('woff2');
...
@font-face {
  ...
  font-weight: 400;
  font-display: optional;
  src: url('font/iJWKBXyIfDnIV7nDrXyw023e1Ik.woff2') format('woff2');
...
@font-face {
  ...
  font-weight: 400;
  font-display: optional;
  src: url('font/iJWKBXyIfDnIV7nPrXyw023e1Ik.woff2') format('woff2');
...
@font-face {
  ...
  font-weight: 400;
  font-display: optional;
  src: url('font/iJWKBXyIfDnIV7nBrXyw023e.woff2') format('woff2');
