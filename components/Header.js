...
export default function Header({ categories }) {
  ...
  return (
    <header className="sticky top-0 bg-white">
      ...
      <nav className={`${ navActive ? 'h-screen pt-16 md:px-4 text-black' : 'h-0 md:px-4 text-white md:text-black' } container mx-auto px-5 bg-white absolute overflow-hidden transition-all ease-in-out duration-300 md:block md:h-[auto] md:static`}>
