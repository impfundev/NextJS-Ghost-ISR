...
export default function Header({ categories }) {
  ...
  return (
    <header className="sticky top-0 bg-slate-100/75 backdrop-blur-sm">
      ...
      <nav className={`${ navActive ? 'h-screen pt-16 md:pt-0 text-black' : 'h-0 text-white md:text-black' } container mx-auto px-5 md:px-4 bg-slate-100/75 backdrop-blur-sm absolute overflow-hidden transition-all ease-in-out duration-300 md:block md:h-[auto] md:static`}>
